...
pub enum Data {
    ...
    Message(Message),
    SendFiles((i32, JobType, String, String, i32, bool, bool, bool)),
    ...
    AddJob((i32, JobType, String, String, i32, bool, bool, bool)),
    ResumeJob((i32, bool)),
    RecordScreen(bool),
    ElevateDirect,
...
pub async fn confirm_insecure_connection(
    ...
    // Auto-continue without prompting for insecure connection.
    true
}
